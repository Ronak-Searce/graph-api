...
var sources = []*ast.Source{
	{Name: "../../api/graph/todo.gql", Input: `type Todo {
  id: ID!
  text: String!
  done: Boolean!
  user: User!
...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewTodo2graphᚑapiᚋpkgᚋgraphᚐNewTodo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Todo)
	fc.Result = res
	return ec.marshalNTodo2ᚖgraphᚑapiᚋpkgᚋgraphᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Todo)
	fc.Result = res
	return ec.marshalNTodo2ᚕᚖgraphᚑapiᚋpkgᚋgraphᚐTodoᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewTodo2graphᚑapiᚋpkgᚋgraphᚐNewTodo(ctx context.Context, v interface{}) (NewTodo, error) {
...
func (ec *executionContext) marshalNTodo2graphᚑapiᚋpkgᚋgraphᚐTodo(ctx context.Context, sel ast.SelectionSet, v Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚕᚖgraphᚑapiᚋpkgᚋgraphᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2ᚖgraphᚑapiᚋpkgᚋgraphᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTodo2ᚖgraphᚑapiᚋpkgᚋgraphᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
